  ...
  render() {
      ...
      return (
        <View style={{backgroundColor: 'black', height:'100%', width:'100%', justifyContent: 'center', alignItems:'center'}}>
          ...
          <TouchableOpacity onPress={() => sendMessage("Mob::giovannyariel2103@gmail.com::5518991893276")} style={{marginVertical:40, marginHorizontal:20, borderRadius:8, height: 50, width: '98%', backgroundColor:'#262626', borderWidth:2, borderColor:'rgba(255, 255, 255, .4)', justifyContent:"center"}}>
            <View>
